...
function LogoutButton({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1.5 rounded-md bg-surface px-3 py-1.5 text-sm font-medium text-text-secondary transition-colors hover:bg-white/5 hover:text-text-primary ${className}`}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="14"
...
export default function NavBar() {
  ...
  return (
    <nav className="flex shrink-0 items-center justify-between gap-3 border-b border-border bg-surface px-4 py-3">
      ...
      <form onSubmit={handleChannelSubmit} className="flex flex-1 max-w-sm justify-center">
        <input
          type="text"
      ...
      <div className="flex items-center gap-2">
        {user ? (
          <>
            <Link
              to="/settings/profile"
              className="flex items-center gap-1.5 rounded-md bg-surface-elevated px-3 py-1.5 text-sm font-medium text-text-secondary transition-colors hover:bg-white/5 hover:text-text-primary"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="14"
